package it.pkg.basic.common.dal.generator;
...
public class GeneratorCodeUtil {
     ...
     * 数据库的配置
     */
    private static final String DB_URL = "jdbc:mysql://dev.db.sunmi.com:3306/app_basic?useUnicode=true&characterEncoding=UTF8&useSSL=true&serverTimezone=Asia/Shanghai&autoReconnect=true&allowPublicKeyRetrieval=false&failOverReadOnly=false";
    private static final String USERNAME = "app_basic";
     ...
     * 代码生成位置
     */
    public static final String PARENT_NAME = "com.sunmi.sbs.basic";
